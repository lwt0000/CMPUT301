    ...
    process(present_state,coins_in,item_sel)
        ...
        case present_state is
            ...
            when sum_10 => 
                          ...
                          if(item_sel='0')then
                            --phone case is selected, $10 is good
                                change_out <= "000";
                                next_state <= dispense;
                          else
                                --need more coins inserted
                            if(coins_in="000")then       -- nothing inserted
                                next_state <= sum_10;
                            elsif(coins_in="001")then    -- again 5$ inserted
                                next_state <= sum_15;
            ...
            when sum_15 =>
                          ...
                          if(item_sel='1')then
                            --airbuds is selected, $15 is good
                                change_out <= "000";
                                next_state <= dispense;
                          else --case is selected
                                -- we can go back to sum10, give change $5
                                change_out <= "001";
                                next_state <= sum_10;
                          end if;
            ...
            when sum_20 =>
                          ...
                          if(item_sel='0')then
                            --phone case is selected
                                change_out <= "010";--giv back $10
                                next_state <= sum_10;
                          else
                                -- airbuds are selected
                                change_out <= "001";--give back $5
                                next_state <= sum_15;
                          end if;                 
